...
When reference building attributes are incomplete, predictions of building type, construction year, and floor count can support preliminary building stock assessment and targeted data collection because the attributes remain available for inspection before archetype assignment.
...
The building-level dataset links Mapillary imagery, reference building attributes, reconstructed 3DBAG geometry, \ac{EPC} records, and TABULA-NL archetypes while preserving the data source of each value.
...
Reference and predicted building attributes are compared on the 2,016-building comparison subset using the same fitted classifier.
