...
The direct DINOv2 configuration uses the same frozen backbone to create one cached mean feature vector per building and trains a separate energy class head on these features.
