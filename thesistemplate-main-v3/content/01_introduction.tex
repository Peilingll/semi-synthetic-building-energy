...
Together, these objectives evaluate the complete chain from image-derived building attributes to archetype parameters and energy-class prediction for the same buildings and data partitions.
