...
The direct DINOv2 classifier uses the same frozen backbone but first caches one mean feature vector for each building.
...
Table~\ref{tab:lightgbm_hyperparams} reports the fixed \acs{LightGBM} configuration used with structured building attributes.
