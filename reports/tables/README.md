...
| table | script | result |
|---|---|---|
| `stage1/T1_per_city_train_holdout` | `notebooks/_build_04.py` | 10,086 buildings / 47,150 images, dev 8,068 + hold-out 2,018 |
| `stage1/T1_*_cv_per_fold` | `notebooks/_build_07_resnet.py`, `_build_04.py` | 5-fold CV curves per backbone |
| `stage1/T2_*_holdout_headline` | `src/stage1/eval_holdout.py` | DINOv2 type 0.901 / period 0.901 / year MAE 9.45 |
| `stage1/T3_model_comparison` | `notebooks/_build_08_stage1_compare.py` | DINOv2 ≈ ResNet-50 >> InternVL3 zero-shot |
...
| `stage3/T3_full_comparison` | `notebooks/_build_09_stage3.py` | all routes, one table |
