...
\SetTopic{\raggedright Evaluating Street-View-Derived Attributes as Substitutes for Reference Building Attributes in an Archetype-Based Building-Stock Workflow\endgraf} % Topic of your thesis
% \SetSubtopic{TODO: subtitle if any} % Remove otherwise
\SetAuthor{Pei-Ling Song} % comma separated list for report
\SetMatrikulationNo{037980} % only for thesis
