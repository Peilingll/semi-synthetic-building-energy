...
The prompts were developed using a fixed, class-balanced subset of 200 development buildings and were then frozen before evaluation (\cref{sec:vision_inference_strategies}).
