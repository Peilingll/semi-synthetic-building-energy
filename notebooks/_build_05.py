...
cells = [
    ...
    code(
        ...
        "",
        "DINO_DIR = REPORTS_DIR",
        "fold_history   = [DINO_DIR / f'pooled_dinov2_frozen_fold{f}_history.json' for f in range(5)]",
        "fold_val_preds = [DINO_DIR / f'pooled_dinov2_frozen_fold{f}_val_preds.parquet' for f in range(5)]",
        "agg_path       = DINO_DIR / 'pooled_dinov2_frozen_aggregate_metrics.json'",
        "ho_metrics_path = DINO_DIR / 'holdout_test_dinov2_frozen_metrics.json'",
        "ho_preds_path   = DINO_DIR / 'holdout_test_dinov2_frozen_preds.parquet'",
        "",
        "history = []",
        "history_summaries = []",
